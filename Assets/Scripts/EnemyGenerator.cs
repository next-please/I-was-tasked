...
public class EnemyGenerator
{
    ...
    public List<Piece> wave1Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = new Piece("Enemy #1)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 160, 100, 10, 1, 5, 5, Enums.Spell.Barkskin);
    ...
    public List<Piece> wave2Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = new Piece("Enemy #1)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 120, 100, 8, 1, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(0);
                enemy.startingSpot = new Tuple<int, int>(3, 4);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #2)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 90, 100, 12, 1, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
                enemy.startingSpot = new Tuple<int, int>(5, 4);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #1)", "", Enums.Race.Orc, Enums.Job.Priest, 1, true, 60, 100, 5, 2, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
    ...
    public List<Piece> wave3Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Rogue, Enums.Race.Human, false);
                ...
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(0, Enums.Job.Rogue, Enums.Race.Orc, false);
                enemy.SetIsEnemy(true);
    ...
    public List<Piece> wave4Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = new Piece("Enemy #1)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 90, 100, 7, 1, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(0);
                enemy.startingSpot = new Tuple<int, int>(1, 4);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #2)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 90, 100, 5, 1, 4, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
                enemy.startingSpot = new Tuple<int, int>(2, 5);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #3)", "", Enums.Race.Orc, Enums.Job.Mage, 1, true, 60, 100, 5, 6, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
                enemy.startingSpot = new Tuple<int, int>(3, 7);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #4)", "", Enums.Race.Orc, Enums.Job.Mage, 1, true, 60, 100, 6, 6, 6, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
                enemy.startingSpot = new Tuple<int, int>(4, 7);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #5)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 90, 100, 8, 1, 6, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(1);
                enemy.startingSpot = new Tuple<int, int>(5, 5);
                enemies.Add(enemy);
                enemy = new Piece("Enemy #6)", "", Enums.Race.Orc, Enums.Job.Knight, 1, true, 90, 100, 7, 1, 5, 5, Enums.Spell.Barkskin);
                enemy.SetDamageIfSurvive(0);
                enemy.startingSpot = new Tuple<int, int>(6, 4);
                enemies.Add(enemy);
                break;
    ...
    public List<Piece> wave5Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Knight, Enums.Race.Human, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #1");
                enemy.SetTitle("");
                enemy.SetDamageIfSurvive(1);
                ...
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(0, Enums.Job.Priest, Enums.Race.Human, false);
                enemy.SetIsEnemy(true);
    ...
    public List<Piece> wave7Enemies(int index)
    {
        ...
        switch (index)
        {
            case 0:
                ...
                enemy.interactions.Add(new DecayingSynergyEffect(enemy));
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(4, Enums.Job.Priest, Enums.Race.Undead, false);
                ...
                enemy.interactions.Add(new DecayingSynergyEffect(enemy));
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Priest, Enums.Race.Undead, false);
                enemy.SetClass(Enums.Job.Knight);
    ...
    public List<Piece> wave8Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Druid, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #1");
                enemy.SetTitle("");
                enemy.SetRarity(1);
                ...
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Knight, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #2");
                enemy.SetTitle("");
                enemy.SetRarity(1);
                ...
                enemy.startingSpot = new Tuple<int, int>(3, 4);
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(2, Enums.Job.Priest, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #3");
                enemy.SetTitle("");
                enemy.SetRarity(2);
                ...
                enemy.startingSpot = new Tuple<int, int>(4, 5);
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(2, Enums.Job.Mage, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #4");
                enemy.SetTitle("");
                enemy.SetRarity(2);
                ...
                enemies.Add(enemy);
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Mage, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #5");
                enemy.SetTitle("");
                enemy.SetRarity(1);
    ...
    public List<Piece> wave9Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = characterGenerator.GenerateCharacter(1, Enums.Job.Knight, Enums.Race.Undead, false);
                enemy.SetIsEnemy(true);
                enemy.SetName("Enemy #1");
                enemy.SetTitle("");
                enemy.SetDamageIfSurvive(1);
    ...
    public List<Piece> wave10Enemies(int index)
    {
        ...
        {
            case 0:
                enemy = characterGenerator.GenerateCharacter(3, Enums.Job.Rogue, Enums.Race.Elf, false);
                enemy.SetIsEnemy(true);
